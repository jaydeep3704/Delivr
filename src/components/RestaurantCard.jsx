    ...
    <div className='w-[250px] h-[250px] md:w-[325px] md:h-[325px] rounded-3xl p-3 hover:shadow-md cursor-pointer  ' onClick={()=>navigate(`/restaurants/${id}`)}>
       ...
       <div >
            <p className='flex justify-between'>
                <span className='font-semibold text-md md:text-xl'>{restName.length>15?restName.substring(0,15)+"...":restName}</span>
                 <span className='flex items-center gap-2 px-2 py-1 text-xs font-semibold text-white bg-green-700 rounded-lg md:text-sm'>{rating} <FaStar className='text-[12px]'/></span>
            </p>
